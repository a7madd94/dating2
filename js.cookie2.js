...
function wireUpEvents() {
    ...
    window.addEventListener(eventName, function(e) {
		if (!validNavigation) {
            ...
            if (Cookies.get("FirstVisitOps")) {
                if (Cookies.get("IsNotUniqueOps")) {
                    Cookies.remove("IsNotUniqueOps");
                } else {
                    Cookies.set('IsNotUniqueOps', 'true', { expires: exDays });
                }
            } else {
                Cookies.set("FirstVisitOps", 'true', { expires: exDays });
            }
